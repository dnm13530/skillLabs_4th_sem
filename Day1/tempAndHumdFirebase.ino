...
#define FIREBASE_AUTH "AIzaSyA-KcjzTeCL5FpIacTYRlmMWj8ZDoDtqME"
#define WIFI_SSID "Jagadeeshwari"
#define WIFI_PASSWORD "my life 1234"

String FIREBASE_BUCKET = "1RV22CS104";  //Replace with your USN
